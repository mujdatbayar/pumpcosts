...
import javaapplication.PumpSparePartCosts2;
 ...
 * @author soner
 */
public class SparePartCostPanel2 extends javax.swing.JPanel {
   ...
   private void updateCostPanel(String selection) {
    ...
    public void initCostPanel(PumpSparePartCosts2 costs, int typeCnt, int yearCnt) {
            typeCount = typeCnt;
            yearCount = yearCnt;
    ...
    public PumpSparePartCosts2 getCosts(){
        getTableValues();
        PumpSparePartCosts2 newCosts = new PumpSparePartCosts2();
